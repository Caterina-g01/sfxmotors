...
export default function AboutUs() {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="absolute top-1 left-1 w-90 text-[#e2e2e2] z-100 bg-[#33313165] bg-opacity-50 rounded-2xl p-3 sm:top-10 sm:left-10 lg:w-125">
      <p className='text-[16px] sm:text-2xl lg:text-3xl lg:pb-2'>О Нас</p>
      <p className='text-[13px] sm:text-[15px] lg:text-[22px]'>
        Мы - SFX Motors. 
        <br />
